...
2. Après soumission du formulaire
3. Créer les variables qui vont contenir les informations du client
4. Ecrire le script qui permet de déterminer à quel palier peut prétendre un client, selon ses informations (et donc à quel couleur de tarif)
5. Afficher le résultat, par ex. "Votre client a droit au tarif Vert"
